...
## 🚀 About Me
- 🎓 Electronics Engineering Student
- 🔧 Developing **Embedded Systems** using **STM32** and **C**
- 🧩 Designing and validating **PCB boards** with **KiCad**
- 🐍 Using **Python** for scripting, testing, and automation
- 🤝 Open to collaboration on **embedded and hardware-related projects**
...
⭐ *Always learning, building, and improving in embedded systems and electronics.*
